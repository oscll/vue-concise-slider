     ...
     <template v-if="!sliderinit.infinite">
      <div class="slider-item" :style="pages[pages.length-1].style">
        <template v-if="pages[pages.length-1].component">
          <component v-on="$listeners" :pages="pages" :item="pages[pages.length-1]" :sliderinit="sliderinit" :is="pages[pages.length-1].component"></component>
        </template>
     ...
     <template v-if="!sliderinit.infinite">
      <div class="slider-item" :style="pages[0].style">
        <template v-if="pages[0].component">
          <component v-on="$listeners" :pages="pages" :item="pages[0]" :sliderinit="sliderinit" :is="pages[0].component"></component>
        </template>
